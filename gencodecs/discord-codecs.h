...
void discord_thread_response_body_init(
...
void discord_get_channel_messages_init(
...
void discord_bulk_delete_messages_init(
...
void discord_list_active_threads_init(
    struct discord_list_active_threads *this);
void discord_list_active_threads_cleanup(
    struct discord_list_active_threads *this);
...
void discord_create_guild_channel_init(
...
void discord_modify_guild_member_init(
    struct discord_modify_guild_member *this);
void discord_modify_guild_member_cleanup(
    struct discord_modify_guild_member *this);

void discord_modify_current_member_init(
...
void discord_guild_scheduled_event_init(
...
void discord_modify_guild_sticker_init(
...
void discord_modify_current_user_init(
    struct discord_modify_current_user *this);
void discord_modify_current_user_cleanup(
    struct discord_modify_current_user *this);
...
void discord_edit_webhook_message_init(
...
void discord_voice_state_status_cleanup(
...
void discord_interaction_response_init(
...
void discord_edit_followup_message_init(
...
size_t json_values_from_jsmnf(jsmnf *root,
                              const char buf[],
...
size_t snowflakes_from_jsmnf(jsmnf *root,
                             const char buf[],
...
size_t integers_from_jsmnf(jsmnf *root,
                           const char buf[],
...
size_t discord_role_from_jsmnf(jsmnf *root,
                               const char buf[],
...
size_t discord_roles_from_jsmnf(jsmnf *root,
                                const char buf[],
...
size_t discord_application_from_jsmnf(jsmnf *root,
                                      const char buf[],
                                      struct discord_application *this);
size_t discord_application_from_json(const char buf[],
                                     size_t size,
                                     struct discord_application *this);

size_t discord_audit_log_from_jsmnf(jsmnf *root,
                                    const char buf[],
...
size_t discord_invite_from_jsmnf(jsmnf *root,
                                 const char buf[],
...
size_t discord_invites_from_jsmnf(jsmnf *root,
                                  const char buf[],
...
size_t discord_get_invite_from_jsmnf(jsmnf *root,
                                     const char buf[],
...
size_t discord_channel_from_jsmnf(jsmnf *root,
                                  const char buf[],
...
size_t discord_channels_from_jsmnf(jsmnf *root,
                                   const char buf[],
...
size_t discord_message_from_jsmnf(jsmnf *root,
                                  const char buf[],
...
size_t discord_messages_from_jsmnf(jsmnf *root,
                                   const char buf[],
...
size_t discord_followed_channel_from_jsmnf(
    jsmnf *root, const char buf[], struct discord_followed_channel *this);
size_t discord_followed_channel_from_json(
    const char buf[], size_t size, struct discord_followed_channel *this);

size_t discord_thread_members_from_jsmnf(jsmnf *root,
                                         const char buf[],
...
size_t discord_attachments_from_jsmnf(jsmnf *root,
                                      const char buf[],
...
size_t discord_embed_from_jsmnf(jsmnf *root,
                                const char buf[],
...
size_t discord_embeds_from_jsmnf(jsmnf *root,
                                 const char buf[],
...
size_t discord_embed_thumbnail_from_jsmnf(
    jsmnf *root, const char buf[], struct discord_embed_thumbnail *this);
size_t discord_embed_thumbnail_from_json(const char buf[],
                                         size_t size,
                                         struct discord_embed_thumbnail *this);

size_t discord_embed_video_from_jsmnf(jsmnf *root,
                                      const char buf[],
...
size_t discord_embed_image_from_jsmnf(jsmnf *root,
                                      const char buf[],
...
size_t discord_embed_provider_from_jsmnf(jsmnf *root,
                                         const char buf[],
...
size_t discord_embed_author_from_jsmnf(jsmnf *root,
                                       const char buf[],
...
size_t discord_embed_footer_from_jsmnf(jsmnf *root,
                                       const char buf[],
...
size_t discord_embed_field_from_jsmnf(jsmnf *root,
                                      const char buf[],
...
size_t discord_embed_fields_from_jsmnf(jsmnf *root,
                                       const char buf[],
...
size_t discord_modify_channel_from_jsmnf(jsmnf *root,
                                         const char buf[],
...
size_t discord_create_message_from_jsmnf(jsmnf *root,
                                         const char buf[],
...
size_t discord_get_reactions_from_jsmnf(jsmnf *root,
                                        const char buf[],
                                        struct discord_get_reactions *this);
size_t discord_get_reactions_from_json(const char buf[],
                                       size_t size,
                                       struct discord_get_reactions *this);

size_t discord_edit_message_from_jsmnf(jsmnf *root,
                                       const char buf[],
...
size_t discord_emoji_from_jsmnf(jsmnf *root,
                                const char buf[],
                                struct discord_emoji *this);
size_t discord_emoji_from_json(const char buf[],
                               size_t size,
                               struct discord_emoji *this);

size_t discord_emojis_from_jsmnf(jsmnf *root,
                                 const char buf[],
                                 struct discord_emojis *this);
size_t discord_emojis_from_json(const char buf[],
                                size_t size,
                                struct discord_emojis *this);

size_t discord_create_guild_emoji_from_jsmnf(
    jsmnf *root, const char buf[], struct discord_create_guild_emoji *this);
size_t discord_create_guild_emoji_from_json(
    const char buf[], size_t size, struct discord_create_guild_emoji *this);

size_t discord_modify_guild_emoji_from_jsmnf(
    jsmnf *root, const char buf[], struct discord_modify_guild_emoji *this);
size_t discord_modify_guild_emoji_from_json(
    const char buf[], size_t size, struct discord_modify_guild_emoji *this);

size_t discord_guild_from_jsmnf(jsmnf *root,
                                const char buf[],
...
size_t discord_guilds_from_jsmnf(jsmnf *root,
                                 const char buf[],
...
size_t discord_guild_preview_from_jsmnf(jsmnf *root,
                                        const char buf[],
...
size_t discord_guild_member_from_jsmnf(jsmnf *root,
                                       const char buf[],
...
size_t discord_guild_members_from_jsmnf(jsmnf *root,
                                        const char buf[],
...
size_t discord_ban_from_jsmnf(jsmnf *root,
                              const char buf[],
...
size_t discord_bans_from_jsmnf(jsmnf *root,
                               const char buf[],
...
size_t discord_welcome_screen_from_jsmnf(jsmnf *root,
                                         const char buf[],
...
size_t discord_create_guild_from_jsmnf(jsmnf *root,
                                       const char buf[],
...
size_t discord_modify_guild_from_jsmnf(jsmnf *root,
                                       const char buf[],
...
size_t discord_add_guild_member_from_jsmnf(
    jsmnf *root, const char buf[], struct discord_add_guild_member *this);
size_t discord_add_guild_member_from_json(
    const char buf[], size_t size, struct discord_add_guild_member *this);
...
size_t discord_create_guild_ban_from_jsmnf(
    jsmnf *root, const char buf[], struct discord_create_guild_ban *this);
size_t discord_create_guild_ban_from_json(
    const char buf[], size_t size, struct discord_create_guild_ban *this);

size_t discord_create_guild_role_from_jsmnf(
    jsmnf *root, const char buf[], struct discord_create_guild_role *this);
size_t discord_create_guild_role_from_json(
    const char buf[], size_t size, struct discord_create_guild_role *this);
...
size_t discord_modify_guild_role_from_jsmnf(
    jsmnf *root, const char buf[], struct discord_modify_guild_role *this);
size_t discord_modify_guild_role_from_json(
    const char buf[], size_t size, struct discord_modify_guild_role *this);

size_t discord_begin_guild_prune_from_jsmnf(
    jsmnf *root, const char buf[], struct discord_begin_guild_prune *this);
size_t discord_begin_guild_prune_from_json(
    const char buf[], size_t size, struct discord_begin_guild_prune *this);
...
size_t discord_guild_template_from_jsmnf(jsmnf *root,
                                         const char buf[],
...
size_t discord_stage_instance_from_jsmnf(jsmnf *root,
                                         const char buf[],
                                         struct discord_stage_instance *this);
size_t discord_stage_instance_from_json(const char buf[],
                                        size_t size,
                                        struct discord_stage_instance *this);
...
size_t discord_sticker_from_jsmnf(jsmnf *root,
                                  const char buf[],
...
size_t discord_user_from_jsmnf(jsmnf *root,
                               const char buf[],
...
size_t discord_users_from_jsmnf(jsmnf *root,
                                const char buf[],
...
size_t discord_connections_from_jsmnf(jsmnf *root,
                                      const char buf[],
...
size_t discord_create_dm_from_jsmnf(jsmnf *root,
                                    const char buf[],
...
size_t discord_create_group_dm_from_jsmnf(
    jsmnf *root, const char buf[], struct discord_create_group_dm *this);
size_t discord_create_group_dm_from_json(const char buf[],
                                         size_t size,
                                         struct discord_create_group_dm *this);

size_t discord_voice_state_from_jsmnf(jsmnf *root,
                                      const char buf[],
                                      struct discord_voice_state *this);
size_t discord_voice_state_from_json(const char buf[],
                                     size_t size,
                                     struct discord_voice_state *this);

size_t discord_voice_states_from_jsmnf(jsmnf *root,
                                       const char buf[],
                                       struct discord_voice_states *this);
size_t discord_voice_states_from_json(const char buf[],
                                      size_t size,
                                      struct discord_voice_states *this);

size_t discord_voice_regions_from_jsmnf(jsmnf *root,
                                        const char buf[],
                                        struct discord_voice_regions *this);
size_t discord_voice_regions_from_json(const char buf[],
                                       size_t size,
                                       struct discord_voice_regions *this);

size_t discord_webhook_from_jsmnf(jsmnf *root,
                                  const char buf[],
...
size_t discord_webhooks_from_jsmnf(jsmnf *root,
                                   const char buf[],
...
size_t discord_create_webhook_from_jsmnf(jsmnf *root,
                                         const char buf[],
...
size_t discord_modify_webhook_from_jsmnf(jsmnf *root,
                                         const char buf[],
...
size_t discord_execute_webhook_from_jsmnf(
    jsmnf *root, const char buf[], struct discord_execute_webhook *this);
...
size_t discord_identify_from_jsmnf(jsmnf *root,
                                   const char buf[],
                                   struct discord_identify *this);
size_t discord_identify_from_json(const char buf[],
                                  size_t size,
                                  struct discord_identify *this);

size_t discord_voice_state_status_from_jsmnf(
    jsmnf *root, const char buf[], struct discord_voice_state_status *this);
size_t discord_voice_state_status_from_json(
    const char buf[], size_t size, struct discord_voice_state_status *this);

size_t discord_presence_update_from_jsmnf(
    jsmnf *root, const char buf[], struct discord_presence_update *this);
...
size_t discord_team_from_jsmnf(jsmnf *root,
                               const char buf[],
...
size_t discord_component_from_jsmnf(jsmnf *root,
                                    const char buf[],
...
size_t discord_components_from_jsmnf(jsmnf *root,
                                     const char buf[],
...
size_t discord_select_options_from_jsmnf(jsmnf *root,
                                         const char buf[],
...
size_t discord_interaction_from_jsmnf(jsmnf *root,
                                      const char buf[],
...
jsonbcode strings_to_jsonb(jsonb *b,
                           char buf[],
                           size_t size,
...
jsonbcode integers_to_jsonb(jsonb *b,
                            char buf[],
                            size_t size,
...
jsonbcode discord_application_to_jsonb(jsonb *b,
                                       char buf[],
                                       size_t size,
                                       const struct discord_application *this);
size_t discord_application_to_json(char buf[],
                                   size_t size,
                                   const struct discord_application *this);
...
jsonbcode discord_followed_channel_to_jsonb(
    jsonb *b,
    char buf[],
    size_t size,
    const struct discord_followed_channel *this);
size_t discord_followed_channel_to_json(
    char buf[], size_t size, const struct discord_followed_channel *this);

jsonbcode discord_thread_members_to_jsonb(
    jsonb *b,
    char buf[],
    size_t size,
    const struct discord_thread_members *this);
size_t discord_thread_members_to_json(
    char buf[], size_t size, const struct discord_thread_members *this);
...
jsonbcode discord_embed_thumbnail_to_jsonb(
    jsonb *b,
    char buf[],
    size_t size,
    const struct discord_embed_thumbnail *this);
size_t discord_embed_thumbnail_to_json(
    char buf[], size_t size, const struct discord_embed_thumbnail *this);
...
jsonbcode discord_embed_provider_to_jsonb(
    jsonb *b,
    char buf[],
    size_t size,
    const struct discord_embed_provider *this);
size_t discord_embed_provider_to_json(
    char buf[], size_t size, const struct discord_embed_provider *this);

jsonbcode discord_embed_author_to_jsonb(
    jsonb *b,
    char buf[],
    size_t size,
...
jsonbcode discord_embed_footer_to_jsonb(
    jsonb *b,
    char buf[],
    size_t size,
...
jsonbcode discord_embed_fields_to_jsonb(
    jsonb *b,
    char buf[],
    size_t size,
...
jsonbcode discord_modify_channel_to_jsonb(
    jsonb *b,
    char buf[],
    size_t size,
    const struct discord_modify_channel *this);
size_t discord_modify_channel_to_json(
    char buf[], size_t size, const struct discord_modify_channel *this);
...
jsonbcode discord_create_message_to_jsonb(
    jsonb *b,
    char buf[],
    size_t size,
    const struct discord_create_message *this);
size_t discord_create_message_to_json(
    char buf[], size_t size, const struct discord_create_message *this);

jsonbcode discord_get_reactions_to_jsonb(
    jsonb *b,
    char buf[],
    size_t size,
    const struct discord_get_reactions *this);
size_t discord_get_reactions_to_json(char buf[],
                                     size_t size,
                                     const struct discord_get_reactions *this);

jsonbcode discord_edit_message_to_jsonb(
    jsonb *b,
    char buf[],
    size_t size,
...
jsonbcode discord_emoji_to_jsonb(jsonb *b,
                                 char buf[],
                                 size_t size,
                                 const struct discord_emoji *this);
size_t discord_emoji_to_json(char buf[],
                             size_t size,
                             const struct discord_emoji *this);

jsonbcode discord_emojis_to_jsonb(jsonb *b,
                                  char buf[],
                                  size_t size,
                                  const struct discord_emojis *this);
size_t discord_emojis_to_json(char buf[],
                              size_t size,
                              const struct discord_emojis *this);
...
jsonbcode discord_guild_preview_to_jsonb(
    jsonb *b,
    char buf[],
    size_t size,
...
jsonbcode discord_guild_member_to_jsonb(
    jsonb *b,
    char buf[],
    size_t size,
...
jsonbcode discord_guild_members_to_jsonb(
    jsonb *b,
    char buf[],
    size_t size,
...
jsonbcode discord_welcome_screen_to_jsonb(
    jsonb *b,
    char buf[],
    size_t size,
    const struct discord_welcome_screen *this);
size_t discord_welcome_screen_to_json(
    char buf[], size_t size, const struct discord_welcome_screen *this);

jsonbcode discord_create_guild_to_jsonb(
    jsonb *b,
    char buf[],
    size_t size,
...
jsonbcode discord_modify_guild_to_jsonb(
    jsonb *b,
    char buf[],
    size_t size,
...
jsonbcode discord_add_guild_member_to_jsonb(
    jsonb *b,
    char buf[],
    size_t size,
    const struct discord_add_guild_member *this);
size_t discord_add_guild_member_to_json(
    char buf[], size_t size, const struct discord_add_guild_member *this);
...
jsonbcode discord_create_guild_ban_to_jsonb(
    jsonb *b,
    char buf[],
    size_t size,
    const struct discord_create_guild_ban *this);
size_t discord_create_guild_ban_to_json(
    char buf[], size_t size, const struct discord_create_guild_ban *this);
...
jsonbcode discord_guild_template_to_jsonb(
    jsonb *b,
    char buf[],
    size_t size,
    const struct discord_guild_template *this);
size_t discord_guild_template_to_json(
    char buf[], size_t size, const struct discord_guild_template *this);
...
jsonbcode discord_stage_instance_to_jsonb(
    jsonb *b,
    char buf[],
    size_t size,
    const struct discord_stage_instance *this);
size_t discord_stage_instance_to_json(
    char buf[], size_t size, const struct discord_stage_instance *this);
...
jsonbcode discord_create_group_dm_to_jsonb(
    jsonb *b,
    char buf[],
    size_t size,
    const struct discord_create_group_dm *this);
size_t discord_create_group_dm_to_json(
    char buf[], size_t size, const struct discord_create_group_dm *this);

jsonbcode discord_voice_state_to_jsonb(jsonb *b,
                                       char buf[],
                                       size_t size,
                                       const struct discord_voice_state *this);
size_t discord_voice_state_to_json(char buf[],
                                   size_t size,
                                   const struct discord_voice_state *this);

jsonbcode discord_voice_states_to_jsonb(
    jsonb *b,
    char buf[],
    size_t size,
    const struct discord_voice_states *this);
size_t discord_voice_states_to_json(char buf[],
                                    size_t size,
                                    const struct discord_voice_states *this);

jsonbcode discord_voice_regions_to_jsonb(
    jsonb *b,
    char buf[],
    size_t size,
    const struct discord_voice_regions *this);
size_t discord_voice_regions_to_json(char buf[],
                                     size_t size,
                                     const struct discord_voice_regions *this);
...
jsonbcode discord_create_webhook_to_jsonb(
    jsonb *b,
    char buf[],
    size_t size,
    const struct discord_create_webhook *this);
size_t discord_create_webhook_to_json(
    char buf[], size_t size, const struct discord_create_webhook *this);

jsonbcode discord_modify_webhook_to_jsonb(
    jsonb *b,
    char buf[],
    size_t size,
    const struct discord_modify_webhook *this);
size_t discord_modify_webhook_to_json(
    char buf[], size_t size, const struct discord_modify_webhook *this);
...
jsonbcode discord_execute_webhook_to_jsonb(
    jsonb *b,
    char buf[],
    size_t size,
    const struct discord_execute_webhook *this);
size_t discord_execute_webhook_to_json(
    char buf[], size_t size, const struct discord_execute_webhook *this);
...
jsonbcode discord_presence_update_to_jsonb(
    jsonb *b,
    char buf[],
    size_t size,
    const struct discord_presence_update *this);
size_t discord_presence_update_to_json(
    char buf[], size_t size, const struct discord_presence_update *this);
...
jsonbcode discord_select_options_to_jsonb(
    jsonb *b,
    char buf[],
    size_t size,
    const struct discord_select_options *this);
size_t discord_select_options_to_json(
    char buf[], size_t size, const struct discord_select_options *this);
