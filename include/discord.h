 ...
 * @param interaction_token the unique token of the interaction
 * @param params request parameters
 * @CCORD_ret_obj{ret, discord_webhook}
 * @CCORD_return
 */
 ...
 * @CCORD_ret_obj{ret, discord_message}
 * @CCORD_return
 */
 ...
 * @param params request parameters
 * @CCORD_ret_obj{ret, discord_audit_log}
 * @CCORD_return
 */
 ...
 * @CCORD_ret_obj{ret, discord_channel}
 * @CCORD_return
 */
 ...
 * @param params request parameters
 * @CCORD_ret_list{ret, discord_message}
 * @CCORD_return
 */
 ...
 * @param emoji_name the emoji name
 * @param params request parameters
 * @CCORD_ret_list{ret, discord_user}
 * @CCORD_return
 */
 ...
 * @param client the client created with discord_init()
 * @param channel_id the channel that the message belongs to
 * @CCORD_ret_list{ret, discord_invite}
 * @CCORD_return
 */
 ...
 * @param channel_id the channel that the message belongs to
 * @param params request parameters
 * @CCORD_ret_obj{ret, discord_invite}
 * @CCORD_return
 */
 ...
 * @CCORD_return
 */
CCORDcode discord_follow_news_channel(struct discord *client,u64_snowflake_t channel_id,
 ...
 * @param params request parameters
 * @CCORD_ret_obj{ret, discord_thread_channel}
 * @CCORD_return
 */
 ...
 * @param client the client created with discord_init()
 * @param channel_id the thread to be joined
 * @CCORD_ret_list{ret, discord_thread_member}
 * @CCORD_return
 */
 ...
 * @CCORD_ret_list{ret, discord_emoji}
 * @CCORD_return
 */
 ...
 * @CCORD_ret_obj{ret, discord_emoji}
 * @CCORD_return
 */
 ...
 * @param client the client created with discord_init()
 * @param params request parameters
 * @CCORD_ret_obj{ret, discord_guild}
 * @CCORD_return
 */
 ...
 * @CCORD_ret_obj{ret, discord_guild_preview}
 * @CCORD_return
 */
 ...
 * @CCORD_ret_list{ret, discord_channel}
 * @CCORD_return
 */
 ...
 * @CCORD_ret_obj{ret, discord_guild_member}
 * @CCORD_return
 */
 ...
 * @CCORD_ret_list{ret, discord_guild_member}
 * @CCORD_return
 */
 ...
 * @CCORD_return
 */
CCORDcode discord_add_guild_member(struct discord *client,u64_snowflake_t guild_id,
                                   u64_snowflake_t user_id,
 ...
 * @CCORD_ret_list{ret, discord_ban}
 * @CCORD_return
 */
 ...
 * @CCORD_ret_list{ret, discord_role}
 * @CCORD_return
 */
 ...
 * @param params request parameters
 * @CCORD_ret_obj{ret, discord_role}
 * @CCORD_return
 */
 ...
 * @CCORD_ret_obj{ret, discord_guild_welcome_screen}
 * @CCORD_return
 */
 ...
 * @CCORD_ret_obj{ret, discord_guild_template}
 * @CCORD_return
 */
 ...
 *
 * @param client the client created with discord_init()
 * @CCORD_ret_obj{ret, discord_user}
 * @CCORD_return
 */
 ...
 *
 * @param client the client created with discord_init()
 * @CCORD_ret_list{ret, discord_guild}
 * @CCORD_return
 */
 ...
 *
 * @param client the client created with discord_init()
 * @CCORD_ret_list{ret, discord_connection}
 * @CCORD_return
 */
 ...
 *
 * @param client the client created with discord_init()
 * @CCORD_ret_list{ret, discord_voice_region}
 * @CCORD_return
 */
 ...
 * @CCORD_ret_list{ret, discord_webhook}
 * @CCORD_return
 */
 ...
 * @CCORD_return
 */
CCORDcode discord_execute_webhook(struct discord *client,u64_snowflake_t webhook_id,
                                  const char webhook_token[],
 ...
 * @CCORD_return
 */
CCORDcode discord_edit_webhook_message(struct discord *client,u64_snowflake_t webhook_id,
                                       const char webhook_token[],
                                       u64_snowflake_t message_id,
 ...
 */
typedef enum discord_event_scheduler (*discord_on_scheduler)(struct discord *client,
...
typedef void (*discord_on_channel_pins_update)(struct discord *client,
                                               u64_snowflake_t guild_id,
                                               u64_snowflake_t channel_id,
...
typedef void (*discord_on_guild_role_delete)(struct discord *client,
                                             u64_snowflake_t guild_id,
                                             u64_snowflake_t role_id);
typedef void (*discord_on_guild_member)(struct discord *client,
                                        u64_snowflake_t guild_id,
                                        const struct discord_guild_member *member);
typedef void (*discord_on_guild_member_remove)(struct discord *client,
                                               u64_snowflake_t guild_id,
                                               const struct discord_user *user);
typedef void (*discord_on_guild_ban)(struct discord *client,
                                     u64_snowflake_t guild_id,
                                     const struct discord_user *user);
typedef void (*discord_on_interaction)(struct discord *client,
...
typedef void (*discord_on_message_delete_bulk)(struct discord *client,
                                               ...
                                               u64_snowflake_t channel_id,
                                               u64_snowflake_t guild_id);
typedef void (*discord_on_message_reaction_add)(struct discord *client,
                                                u64_snowflake_t user_id,
                                                u64_snowflake_t channel_id,
                                                u64_snowflake_t message_id,
                                                u64_snowflake_t guild_id,
...
typedef void (*discord_on_message_reaction_remove)(struct discord *client,
                                                   u64_snowflake_t user_id,
                                                   u64_snowflake_t channel_id,
                                                   u64_snowflake_t message_id,
                                                   u64_snowflake_t guild_id,
                                                   const struct discord_emoji *emoji);
typedef void (*discord_on_message_reaction_remove_all)(struct discord *client,
                                                       u64_snowflake_t channel_id,
                                                       u64_snowflake_t message_id,
                                                       u64_snowflake_t guild_id);
typedef void (*discord_on_message_reaction_remove_emoji)(struct discord *client,
                                                         u64_snowflake_t channel_id,
                                                         u64_snowflake_t message_id,
                                                         u64_snowflake_t guild_id,
                                                         const struct discord_emoji *emoji);
typedef void (*discord_on_voice_state_update)(struct discord *client,
