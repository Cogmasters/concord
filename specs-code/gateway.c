...
void discord_gateway_identify_from_json(char *json, size_t len, struct discord_gateway_identify *p)
{
  ...
  */
  /* specs/gateway.json:81:19
     '{ "name":"presence","type":{"base":"struct discord_gateway_identify_status_update", "dec":"*"}}'
  */
                discord_gateway_identify_status_update_from_json, p->presence,
  /* specs/gateway.json:82:19
     '{ "name":"intents","type":{"base":"int"}}'
  */
                &p->intents,
...
size_t discord_gateway_identify_to_json(char *json, size_t len, struct discord_gateway_identify *p)
{
  ...
  */
  /* specs/gateway.json:81:19
     '{ "name":"presence","type":{"base":"struct discord_gateway_identify_status_update", "dec":"*"}}'
  */
                discord_gateway_identify_status_update_to_json, p->presence,
  /* specs/gateway.json:82:19
     '{ "name":"intents","type":{"base":"int"}}'
  */
                &p->intents,
...
void discord_gateway_identify_cleanup(struct discord_gateway_identify *d) {
  ...
  */
  if (d->presence)
    discord_gateway_identify_status_update_free(d->presence);
  /* specs/gateway.json:82:19
     '{ "name":"intents","type":{"base":"int"}}'
  */
...
void discord_gateway_identify_init(struct discord_gateway_identify *p) {
  ...
  */
  ...
  /* specs/gateway.json:81:19
     '{ "name":"presence","type":{"base":"struct discord_gateway_identify_status_update", "dec":"*"}}'
  */
  p->presence = discord_gateway_identify_status_update_alloc();
...
void discord_gateway_identify_status_update_from_json(char *json, size_t len, struct discord_gateway_identify_status_update *p)
{
  static size_t ret=0; // used for debugging
  size_t r=0;
  r=json_extract(json, len, 
  ...
  */
  ...
  /* specs/gateway.json:94:19
     '{ "name":"activities","type":{"base":"struct discord_gateway_identify_status_update_activity", "dec":"ntl"}, 
          "option":true, "inject_if_not":null}'
  */
                discord_gateway_identify_status_update_activity_list_from_json, &p->activities,
  /* specs/gateway.json:96:19
     '{ "name":"status","type":{"base":"char", "dec":"[16]"}}'
  */
                p->status,
...
static void discord_gateway_identify_status_update_use_default_inject_settings(struct discord_gateway_identify_status_update *p)
{
  p->__M.enable_arg_switches = true;
  /* specs/gateway.json:92:19
     '{ "name":"since","type":{"base":"char", "dec":"*", "converter":"iso8601"},
...
size_t discord_gateway_identify_status_update_to_json(char *json, size_t len, struct discord_gateway_identify_status_update *p)
{
  size_t r;
  discord_gateway_identify_status_update_use_default_inject_settings(p);
  r=json_inject(json, len, 
  /* specs/gateway.json:92:19
     '{ "name":"since","type":{"base":"char", "dec":"*", "converter":"iso8601"},
          "option":true, "inject_if_not":0 }'
  ...
  */
  ...
  /* specs/gateway.json:94:19
     '{ "name":"activities","type":{"base":"struct discord_gateway_identify_status_update_activity", "dec":"ntl"}, 
          "option":true, "inject_if_not":null}'
  */
                discord_gateway_identify_status_update_activity_list_to_json, p->activities,
  /* specs/gateway.json:96:19
     '{ "name":"status","type":{"base":"char", "dec":"[16]"}}'
  */
                p->status,
...
typedef void (*vfcpsvp)(char *, size_t, void *);
typedef size_t (*sfcpsvp)(char *, size_t, void *);
void discord_gateway_identify_status_update_cleanup_v(void *p) {
  discord_gateway_identify_status_update_cleanup((struct discord_gateway_identify_status_update *)p);
}

void discord_gateway_identify_status_update_init_v(void *p) {
  discord_gateway_identify_status_update_init((struct discord_gateway_identify_status_update *)p);
}

void discord_gateway_identify_status_update_free_v(void *p) {
 discord_gateway_identify_status_update_free((struct discord_gateway_identify_status_update *)p);
};

void discord_gateway_identify_status_update_from_json_v(char *json, size_t len, void *p) {
 discord_gateway_identify_status_update_from_json(json, len, (struct discord_gateway_identify_status_update*)p);
}

size_t discord_gateway_identify_status_update_to_json_v(char *json, size_t len, void *p) {
  return discord_gateway_identify_status_update_to_json(json, len, (struct discord_gateway_identify_status_update*)p);
}

void discord_gateway_identify_status_update_list_free_v(void **p) {
  discord_gateway_identify_status_update_list_free((struct discord_gateway_identify_status_update**)p);
}

void discord_gateway_identify_status_update_list_from_json_v(char *str, size_t len, void *p) {
  discord_gateway_identify_status_update_list_from_json(str, len, (struct discord_gateway_identify_status_update ***)p);
}

size_t discord_gateway_identify_status_update_list_to_json_v(char *str, size_t len, void *p){
  return discord_gateway_identify_status_update_list_to_json(str, len, (struct discord_gateway_identify_status_update **)p);
}


void discord_gateway_identify_status_update_cleanup(struct discord_gateway_identify_status_update *d) {
  /* specs/gateway.json:92:19
     '{ "name":"since","type":{"base":"char", "dec":"*", "converter":"iso8601"},
          "option":true, "inject_if_not":0 }'
  */
  ...
  */
  if (d->activities)
    discord_gateway_identify_status_update_activity_list_free(d->activities);
  /* specs/gateway.json:96:19
     '{ "name":"status","type":{"base":"char", "dec":"[16]"}}'
  */
...
void discord_gateway_identify_status_update_init(struct discord_gateway_identify_status_update *p) {
  memset(p, 0, sizeof(struct discord_gateway_identify_status_update));
  /* specs/gateway.json:92:19
     '{ "name":"since","type":{"base":"char", "dec":"*", "converter":"iso8601"},
          "option":true, "inject_if_not":0 }'
  */
...
struct discord_gateway_identify_status_update* discord_gateway_identify_status_update_alloc() {
  struct discord_gateway_identify_status_update *p= (struct discord_gateway_identify_status_update*)malloc(sizeof(struct discord_gateway_identify_status_update));
  discord_gateway_identify_status_update_init(p);
  return p;
}

void discord_gateway_identify_status_update_free(struct discord_gateway_identify_status_update *p) {
  discord_gateway_identify_status_update_cleanup(p);
  free(p);
}

void discord_gateway_identify_status_update_list_free(struct discord_gateway_identify_status_update **p) {
  ntl_free((void**)p, (vfvp)discord_gateway_identify_status_update_cleanup);
}

void discord_gateway_identify_status_update_list_from_json(char *str, size_t len, struct discord_gateway_identify_status_update ***p)
{
  struct ntl_deserializer d;
  memset(&d, 0, sizeof(d));
  d.elem_size = sizeof(struct discord_gateway_identify_status_update);
  d.init_elem = discord_gateway_identify_status_update_init_v;
  d.elem_from_buf = discord_gateway_identify_status_update_from_json_v;
  d.ntl_recipient_p= (void***)p;
  extract_ntl_from_json(str, len, &d);
}

size_t discord_gateway_identify_status_update_list_to_json(char *str, size_t len, struct discord_gateway_identify_status_update **p)
{
  return ntl_to_buf(str, len, (void **)p, NULL, discord_gateway_identify_status_update_to_json_v);
}
...
void discord_gateway_identify_status_update_activity_from_json(char *json, size_t len, struct discord_gateway_identify_status_update_activity *p)
{
  static size_t ret=0; // used for debugging
  size_t r=0;
  r=json_extract(json, len, 
...
static void discord_gateway_identify_status_update_activity_use_default_inject_settings(struct discord_gateway_identify_status_update_activity *p)
{
  p->__M.enable_arg_switches = true;
  /* specs/gateway.json:119:19
     '{ "name":"name","type":{"base":"char", "dec":"[512]"}}'
...
size_t discord_gateway_identify_status_update_activity_to_json(char *json, size_t len, struct discord_gateway_identify_status_update_activity *p)
{
  size_t r;
  discord_gateway_identify_status_update_activity_use_default_inject_settings(p);
  r=json_inject(json, len, 
  /* specs/gateway.json:119:19
     '{ "name":"name","type":{"base":"char", "dec":"[512]"}}'
  */
...
typedef void (*vfcpsvp)(char *, size_t, void *);
typedef size_t (*sfcpsvp)(char *, size_t, void *);
void discord_gateway_identify_status_update_activity_cleanup_v(void *p) {
  discord_gateway_identify_status_update_activity_cleanup((struct discord_gateway_identify_status_update_activity *)p);
}

void discord_gateway_identify_status_update_activity_init_v(void *p) {
  discord_gateway_identify_status_update_activity_init((struct discord_gateway_identify_status_update_activity *)p);
}

void discord_gateway_identify_status_update_activity_free_v(void *p) {
 discord_gateway_identify_status_update_activity_free((struct discord_gateway_identify_status_update_activity *)p);
};

void discord_gateway_identify_status_update_activity_from_json_v(char *json, size_t len, void *p) {
 discord_gateway_identify_status_update_activity_from_json(json, len, (struct discord_gateway_identify_status_update_activity*)p);
}

size_t discord_gateway_identify_status_update_activity_to_json_v(char *json, size_t len, void *p) {
  return discord_gateway_identify_status_update_activity_to_json(json, len, (struct discord_gateway_identify_status_update_activity*)p);
}

void discord_gateway_identify_status_update_activity_list_free_v(void **p) {
  discord_gateway_identify_status_update_activity_list_free((struct discord_gateway_identify_status_update_activity**)p);
}

void discord_gateway_identify_status_update_activity_list_from_json_v(char *str, size_t len, void *p) {
  discord_gateway_identify_status_update_activity_list_from_json(str, len, (struct discord_gateway_identify_status_update_activity ***)p);
}

size_t discord_gateway_identify_status_update_activity_list_to_json_v(char *str, size_t len, void *p){
  return discord_gateway_identify_status_update_activity_list_to_json(str, len, (struct discord_gateway_identify_status_update_activity **)p);
}


void discord_gateway_identify_status_update_activity_cleanup(struct discord_gateway_identify_status_update_activity *d) {
  /* specs/gateway.json:119:19
     '{ "name":"name","type":{"base":"char", "dec":"[512]"}}'
  */
  //p->name is a scalar
...
void discord_gateway_identify_status_update_activity_init(struct discord_gateway_identify_status_update_activity *p) {
  memset(p, 0, sizeof(struct discord_gateway_identify_status_update_activity));
  /* specs/gateway.json:119:19
     '{ "name":"name","type":{"base":"char", "dec":"[512]"}}'
  */
...
struct discord_gateway_identify_status_update_activity* discord_gateway_identify_status_update_activity_alloc() {
  struct discord_gateway_identify_status_update_activity *p= (struct discord_gateway_identify_status_update_activity*)malloc(sizeof(struct discord_gateway_identify_status_update_activity));
  discord_gateway_identify_status_update_activity_init(p);
  return p;
}

void discord_gateway_identify_status_update_activity_free(struct discord_gateway_identify_status_update_activity *p) {
  discord_gateway_identify_status_update_activity_cleanup(p);
  free(p);
}

void discord_gateway_identify_status_update_activity_list_free(struct discord_gateway_identify_status_update_activity **p) {
  ntl_free((void**)p, (vfvp)discord_gateway_identify_status_update_activity_cleanup);
}

void discord_gateway_identify_status_update_activity_list_from_json(char *str, size_t len, struct discord_gateway_identify_status_update_activity ***p)
{
  struct ntl_deserializer d;
  memset(&d, 0, sizeof(d));
  d.elem_size = sizeof(struct discord_gateway_identify_status_update_activity);
  d.init_elem = discord_gateway_identify_status_update_activity_init_v;
  d.elem_from_buf = discord_gateway_identify_status_update_activity_from_json_v;
  d.ntl_recipient_p= (void***)p;
  extract_ntl_from_json(str, len, &d);
}

size_t discord_gateway_identify_status_update_activity_list_to_json(char *str, size_t len, struct discord_gateway_identify_status_update_activity **p)
{
  return ntl_to_buf(str, len, (void **)p, NULL, discord_gateway_identify_status_update_activity_to_json_v);
}
